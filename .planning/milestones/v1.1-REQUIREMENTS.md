# Requirements Archive: v1.1 Core Validation & Hardening

**Archived:** 2026-06-07
**Status:** SHIPPED
**Outcome:** 9 / 9 requirements complete (validated). pytest 29/29 green; `main.py` smoke-run preserved the core methodology numbers.
